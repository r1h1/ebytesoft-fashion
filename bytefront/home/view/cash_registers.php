...
<body>
                ...
                <div class="mx-auto">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-lg-6 mt-5 text-center">
                            <p class="h3"><i class="fa-solid fa-cash-register h1 me-2"></i> <span class="fw-bold h2">Cajas
                            ...
                            <div class="card">
                                <div class="card-body p-3">
                                    ...
                                    <div class="icon p-1 text-center">
                                        <p class="fw-bold h1" id="total-cajas"></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="row g-3">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" class="form-control gray inputClass" placeholder="Código" id="caja-codigo" hidden>
                                                </div>
                                                <div class="col-12">
                                                    <label class="text-muted form-label">Local Pertenece *</label>
                                                    <select class="form-select gray inputClass" id="localesN">

                                                    </select>
                                                </div>
                                                <div class="col-12">
                                                    <input type="text" class="form-control gray inputClass" placeholder="Nombre Caja *" id="nombreN">
                                                </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="row g-3">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" class="form-control gray inputClass" id="idcr" hidden>
                                                </div>
                                                <div class="col-md-12">
                                                ...
                                                <div class="col-12">
                                                    <label class="form-label text-muted">Asignar Nuevo Local *</label>
                                                    <select class="form-select gray inputClass" id="localesE">

                                                    </select>
                                                </div>
                                                <div class="col-12">
                                                    <input type="text" class="form-control gray inputClass" placeholder="Nombre Local *" id="nombreE">
                                                </div>
                                                <div class="col-12 text-center">
                                                    <a class="btn btn-success px-3 py-2" onclick="put()"><i class="fa-solid fa-floppy-disk me-2"></i> Guardar
                                                        Datos</a>
                                                </div>
                                            </form>
                                        ...
                                        <div class="modal-footer gray text-center">
                                            <p class="text-muted mt-2 mb-2">Puedes editar toda la información que necesites desde este módulo
                                            </p>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="../../logic/cash_registers/crud.js"></script>
    <script>
