...
<body>
    ...
    <main class="container">
        ...
        <div class="row px-3">
                    ...
                    <div class="row">
                        <div class="col text-muted text-center">
                            ...
                            <button class="btn btn-warning mt-3" data-bs-toggle="modal"
                                data-bs-target="#editarDatosPerfil"><i class="fa-solid fa-pen me-2"></i> Editar mis
                                Datos</button>
                        </div>
                    </div>
                </div>
            ...
            <!-- Modal -->
            <div class="modal fade" id="editarDatosPerfil" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="row g-3">
                                <div class="col-md-12">
                                    <input type="text" class="form-control gray inputClass" id="inputEmail4"
                                        placeholder="Nombre *">
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-12">
                                    <input type="number" class="form-control gray inputClass"
                                        placeholder="Clave de Acceso *" min="1">
                                </div>
                                <div class="col-12 text-center">
                                    <button type="submit" class="btn btn-success px-2 py-2"><i
                                            class="fa-solid fa-floppy-disk me-2"></i> Guardar Datos</button>
                                </div>
                            </form>
                        </div>
