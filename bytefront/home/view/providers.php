                ...
                <div class="mx-auto">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-lg-6 mt-5 text-center">
                            <p class="h3"><i class="fa-solid fa-people-carry-box h1 me-2"></i> <span class="fw-bold h2">Proveedores</span></p>
                        </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="row g-3">
                                                ...
                                                <div class="col-12">
                                                    <input type="text" class="form-control gray inputClass" placeholder="Tipo de Pago *" id="tpago_provn">
                                                </div>
                                                <div class="col-12">
                                                    <input type="number" class="form-control gray inputClass" placeholder="Teléfono *" min="1" id="numero_provn">
                                                </div>
                                                <div class="col-12">
                                                    <input type="text" class="form-control gray inputClass" placeholder="Dirección *" id="direccion_provn">
                                                </div>
                                                <div class="col-12">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="row g-3">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" class="form-control gray inputClass" id="id_prove" hidden>
                                                </div>
                                                <div class="col-md-12">
                                                    <input type="text" class="form-control gray inputClass" placeholder="Código" id="codigo_prove" hidden>
                                                </div>
                                                <div class="col-md-12">
                                                    <input type="text" class="form-control gray inputClass" placeholder="Tipo de Proveedor *" id="tipo_prove" min="1">
                                                </div>
                                                <div class="col-12">
                                                    <input type="text" class="form-control gray inputClass" placeholder="Tipo de Pago *" id="tpago_prove">
                                                </div>
                                                <div class="col-12">
                                                    <input type="number" class="form-control gray inputClass" placeholder="Teléfono *" min="1" id="numero_prove">
                                                </div>
                                                <div class="col-12">
                                                    <input type="text" class="form-control gray inputClass" placeholder="Dirección *" id="direccion_prove">
                                                </div>
                                                <div class="col-12">
                                                    <input type="email" class="form-control gray inputClass" placeholder="Correo Electrónico *" id="email_prove">
                                                </div>
                                                <div class="col-12 text-center">
