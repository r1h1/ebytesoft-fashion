                ...
                <div class="mx-auto">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-lg-6 mt-5 text-center">
                            <p class="h3"><i class="fa-solid fa-tag h1 me-2"></i> <span class="fw-bold h2">Listas de Descuentos</span></p>
                        </div>

                        <div class="col-lg-6 mt-2">
                            <div class="card">
                                <div class="card-body p-3">
                                    <p class="card-text text-muted fw-bold">Listas Registradas</p>
                                    <div class="icon p-1 text-center">
                                        <p class="fw-bold h1" id="total-listas"></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col px-3 mt-5">
                        ...
                        <div class="header text-end mb-3">
                            <a class="btn btn-success mt-4" data-bs-toggle="modal" data-bs-target="#nuevo" onclick="codigo()">
                                <i class="fa-solid fa-plus me-2 py-2"></i> Nueva Lista de Precios</a>
                        </div>
                        ...
                        <div class="table-responsive mt-5 mb-5">
                            <table id="example" class="table table-striped">
                                <thead class=" blue text-white">
                                    <tr>
                                        <th scope="col">#</th>
                                        <th scope="col">Nombre Lista de Precios</th>
                                        <th scope="col">Precio</th>
                                        <th scope="col">Lista de Descuentos</th>
                                        <th scope="col">Descuento Especifico</th>
                                        <th scope="col">Categoría Aplica Lista Descuento</th>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="row g-3">
                                                ...
                                                <div class="col-12">
                                                    <input type="text" class="form-control gray inputClass" placeholder="Nombre de la Lista *" id="nombreN">
                                                </div>
                                                <div class="col-12">
                                                    <select class="form-select gray inputClass" id="opcionN">
                                                        <option selected>Opción de Descuento *</option>
                                                        <option value="Porcentaje">Porcentaje</option>
                                                        <option value="Precio Específico">Descuento Específico</option>
                                                    </select>
                                                </div>
                                                <div class="col-12">
                                                    <input type="text" class="form-control gray inputClass" placeholder="Porcentaje de Descuento *" id="nombreN">
                                                </div>
                                                <div class="col-12">
                                                    <input type="text" class="form-control gray inputClass" placeholder="Descuento Específico *" id="nombreN">
                                                </div>
                                                <div class="col-12">
                                                    <label class="text-muted">Categorías Aplica Descuento *</label>
                                                    <select class="form-select gray inputClass" id="categoriasN">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped">
                                                            <thead class="blue text-white">
                                                                <tr>
                                                                    <th scope="col">#</th>
                                                                    <th scope="col">Categorias Seleccionadas</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody id="categorias-seleccionadas-tabla">
                                                                <tr>
                                                                    <td></td>
                                                ...
                                                <div class="col-12 text-center">
                                                    <a class="btn btn-success px-3 py-2"><i class="fa-solid fa-floppy-disk me-2"></i> Guardar
                                                        Datos</a>
                                                </div>
                                            </form>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="row g-3">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" class="form-control gray inputClass" id="idd" hidden>
                                                </div>
                                                <div class="col-12">
                                                    <input type="text" class="form-control gray inputClass" placeholder="Nombre de la Lista *" id="nombreN">
                                                </div>
