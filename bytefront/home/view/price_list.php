                ...
                <div class="mx-auto">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-lg-6 mt-5 text-center">
                            <p class="h3"><i class="fa-solid fa-hand-holding-dollar h1 me-2"></i> <span class="fw-bold h2">Listas de Precios</span></p>
                        </div>
                    ...
                    <div class="col px-3 mt-5">
                        ...
                        <div class="header text-end mb-3">
                            <a class="btn btn-success mt-4" data-bs-toggle="modal" data-bs-target="#nuevo" onclick="codigo()">
                                <i class="fa-solid fa-plus me-2 py-2"></i> Nueva Lista de Precio</a>
                        </div>
                        ...
                        <div class="table-responsive mt-5 mb-5">
                            <table id="example" class="table table-striped">
                                <thead class=" blue text-white">
                                    <tr>
                                        <th scope="col">#</th>
                                        <th scope="col">Nombre Lista de Precio</th>
                                        <th scope="col">Precio</th>
                                        <th scope="col">Productos Que Aplican</th>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="row g-3">
                                                ...
                                                <div class="col-12">
                                                    <input type="text" class="form-control gray inputClass" placeholder="Precio *" id="precioN">
                                                </div>
                                                <div class="col-12">
                                                    <label class="text-muted">Productos Aplica Precio *</label>
                                                    <select class="form-select gray inputClass" id="productosPrecioN">
                                                ...
                                                <div class="col-12 mt-4">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped">
                                                            ...
                                                            <tbody id="productos-seleccionados-tabla">
                                                                <tr>
                                                                    <td></td>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="row g-3">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" class="form-control gray inputClass" id="idpl" hidden>
                                                </div>
                                                <div class="col-12">
                                                    <input type="text" class="form-control gray inputClass" placeholder="Nombre de la Lista *" id="nombreN">
                                                </div>
