                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="row g-3">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" class="form-control gray inputClass" placeholder="Código" id="codigo_n" hidden>
                                                </div>
                                                <div class="col-md-12">
                                                ...
                                                <div class="col-12">
                                                    <input type="number" class="form-control gray inputClass" placeholder="Teléfono *" min="1" id="telefono_n">
                                                </div>
                                                <div class="col-12">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="row g-3">
                                                ...
                                                <div class="col-12">
                                                    <input type="number" class="form-control gray inputClass" placeholder="Teléfono *" min="1" id="telefono_e">
                                                </div>
                                                <div class="col-12">
